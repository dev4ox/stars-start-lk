    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_services', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='registration.groupservices')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='service',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='registration.services'),
        ),
        migrations.AddField(
            model_name='category',
            name='service',
